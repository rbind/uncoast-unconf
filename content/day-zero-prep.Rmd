...
We're all looking forward to getting togther in Des Moines; we want everyone to be ready! This material may be useful to you regardless of your day-zero attendance.
...
Just about all of this material was compiled by our friend Jenny Bryan, in her book [Happy Git with R](https://happygitwithr.com). In our material, we will hit the high points, then link to the source material in case you want more background.
...
- if you do not have an account already, please [sign up for one](https://github.com/join), and keep your login-credentials handy:
...
If you can get through these steps, you are OK for this week:

1. With your (new) version of the RStudio IDE, open the Terminal pane, type the command `date`, then enter. Your computer should return the current date and time.

2. Having signed into GitHub, go to [this issue]() on our Unconf issues page, either to introduce yourself, or to add an emoji reaction. Once you have done this, you are very welcome (in fact, encouraged) to participate in some of the [other issue discussions](https://github.com/uncoast-unconf/uu-2019/issues), or even start new ones.

If you have any problems, you can raise it as a new [GitHub issue](https://github.com/uncoast-unconf/uu-2019/issues), or email Ian Lyttle at ian [dot] lyttle [at] se [dot] com. 
